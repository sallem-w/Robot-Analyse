...
ActivInfinitev7.step({ stInitScenarioCreationContrat: function(ev, sc, st) {
	var data = sc.data;
	ctx.traceF.infoTxt(data.contratCourantAdhesion.dataLocale.assurePrincipal.NUM_SEQ_CT + ' - Etape - stInitScenarioCreation');
	var gamme = data.contratCourantAdhesion.dataLocale.assurePrincipal.GAMME;
