...
ActivInfinitev7.pTabDeBord.btSynthesisMenu = ActivInfinitev7.pTabDeBord.addItem('btSynthesisMenu', {"mustExist":true});
ActivInfinitev7.pTabDeBord.btIndividualContract = ActivInfinitev7.pTabDeBord.addItem('btIndividualContract');
ActivInfinitev7.pTabDeBord.btContractContexte = ActivInfinitev7.pTabDeBord.addItem('btContractContexte');
ActivInfinitev7.pTabDeBord.btIndivContractMenu = ActivInfinitev7.pTabDeBord.addItem('btIndivContractMenu');
ActivInfinitev7.pTabDeBord.btConsultation = ActivInfinitev7.pTabDeBord.addItem('btConsultation');
ActivInfinitev7.pTabDeBord.btCoverageChangeMenu = ActivInfinitev7.pTabDeBord.addItem('btCoverageChangeMenu');
ActivInfinitev7.pTabDeBord.btCoverageChange = ActivInfinitev7.pTabDeBord.addItem('btCoverageChange');
ActivInfinitev7.pTabDeBord.btTerminatedContract = ActivInfinitev7.pTabDeBord.addItem('btTerminatedContract');
ActivInfinitev7.pTabDeBord.btMembershipCollectiv = ActivInfinitev7.pTabDeBord.addItem('btMembershipCollectiv');
ActivInfinitev7.pTabDeBord.btSanteSouscription = ActivInfinitev7.pTabDeBord.addItem('btSanteSouscription');
ActivInfinitev7.pTabDeBord.btTerminatedMenu = ActivInfinitev7.pTabDeBord.addItem('btTerminatedMenu');
ActivInfinitev7.pTabDeBord.btTerminatedCMU = ActivInfinitev7.pTabDeBord.addItem('btTerminatedCMU');
ActivInfinitev7.pTabDeBord.btTerminatedInAdvance = ActivInfinitev7.pTabDeBord.addItem('btTerminatedInAdvance');
ActivInfinitev7.pTabDeBord.btTerminatedProduct = ActivInfinitev7.pTabDeBord.addItem('btTerminatedProduct');
ActivInfinitev7.pTabDeBord.btParticularSituation = ActivInfinitev7.pTabDeBord.addItem('btParticularSituation');
